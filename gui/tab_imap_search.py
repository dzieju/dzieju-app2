...
class IMAPSearchTab(ttk.Frame):
    ...
    def _load_saved_exclusions(self):
        ...
        try:
            if os.path.exists(IMAP_SEARCH_CONFIG_FILE):
                with open(IMAP_SEARCH_CONFIG_FILE, "r", encoding='utf-8') as f:
                    config = json.load(f)
    ...
    def save_mail_search_config(self, show_message=True):
        ...
        try:
            ...
            with open(IMAP_SEARCH_CONFIG_FILE, "w", encoding='utf-8') as f:
