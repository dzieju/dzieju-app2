"""
IMAP-specific mail configuration widget supporting IMAP/SMTP and POP3
"""
try:
    ...
    raise ImportError("IMAPConfigWidget requires tkinter")
...
class IMAPConfigWidget(ttk.Frame):
